...
type HeaderProps = {}
  ...
  const Header = (props: HeaderProps) => {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full bg-white border-t border-gray-200 shadow z-50">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-gray">
                    <li>
                    <Link to="/" className="block py-2 px-3 text-gray bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-gray md:dark:text-blue-500" aria-current="page">Recipes</Link>
                    </li>
                    <li>
